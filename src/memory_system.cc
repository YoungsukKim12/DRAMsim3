...
bool MemorySystem::AddTransaction(uint64_t hex_addr, bool is_write, bool transfer_vec, bool is_r_vec) {
    return dram_system_->AddTransaction(hex_addr, is_write, transfer_vec, is_r_vec);
}
