...
class BaseDRAMSystem {
   public:
    ...
    virtual bool AddTransaction(uint64_t hex_addr, bool is_write, bool transfer_vec, bool is_r_vec) = 0;
...
class JedecDRAMSystem : public BaseDRAMSystem {
   public:
    ...
    bool AddTransaction(uint64_t hex_addr, bool is_write, bool transfer_vec, bool is_r_vec) override;
